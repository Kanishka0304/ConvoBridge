    ...
    LazyColumn(modifier = modifier) {
        items(chatMessages){
            ...
            Column (
                ...
                androidx.compose.material3.Text(text = msg.message?:"",
                    modifier = Modifier
...
fun ChatHeader(name: String, imageUrl : String, onBackClicked: ()-> Unit) {
    Row(
        ...
        androidx.compose.material3.Text(text = name, fontWeight = FontWeight.Bold, modifier =Modifier.padding(start = 4.dp))
    }
}
